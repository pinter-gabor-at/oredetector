...
public class GoldDetector extends DetectOreDetector {
	...
	public GoldDetector(Properties props, int focus) {
		super(props, focus);
		bangs = ModSounds.DETECTOR_3BANGS[3].value();
	}
...

	{
		ECHOLIST = List.of(
			...
			new DetectOreDetector.Echo(ModBlockTags.COPPER, 4, Blocks.COPPER_BLOCK.weathering().unaffected()),
	...
	@Override
	public int getRange() {
		return ModConfigData.RANGE_GOLD_DETECTOR.get();
	}
}
